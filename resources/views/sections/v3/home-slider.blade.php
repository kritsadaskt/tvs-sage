...
<div id="home_slider_section" class="md:h-1/2 lg:h-[90vh] relative bg-black flex items-center pt-10 pb-5">
  ...
  <div class="container">
    <div id="home_slider" class="swiper py-16 px-2 lg:py-[8rem] lg:px-0">
      <div class="swiper-wrapper">
        @foreach ($hero_slides as $slide)
          @php
            $medias = $slide['medias'];
          @endphp
          <div class="swiper-slide" data-backdrop="{{$medias['thumbnail']}}" data-title="{{$slide['title']}}" data-desc="{{$slide['description']}}">
            <img src="{{$medias['thumbnail']}}" alt="">
          </div>
        @endforeach
      </div>
    </div>
    <div class="description w-11/12 mx-auto md:w-3/5 text-white text-center flex flex-col gap-[3px] z-[1] relative transition ease-out duration-500">
    ...
    <div class="w-full mx-auto md:w-4/5 h-[55px] md:h-auto flex justify-between gap-10 md:gap-0 px-2 md:px-0">

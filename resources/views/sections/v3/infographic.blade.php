...
<div id="infographic" class="min-h-fit bg-white pt-20 pb-11">
  <div class="container flex justify-between items-center mb-12">
    <h2 class="text-[32px] font-semibold border-l-[19px] border-tvs-orange-1 pl-3">INFOGRAPHICS</h2>
    <a href="" class="text-tvs-gray-2 flex gap-2 items-center">
  ...
  <div class="container flex-col-reverse md:flex-row flex gap-5">
    <div id="infos_slides_wrapper" class="w-full relative">
      <div id="infos_slider" class="swiper w-10/12 mx-auto py-32">
      ...
      <div class="info-navi absolute w-full h-14 top-1/2 -mt-6">

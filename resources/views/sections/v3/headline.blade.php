      ...
      @foreach ($cat as $box)
        ...
        {{-- @elseif ($loop->index <= 1)
          <a href="{{ $box['link'] }}" class="box group text-white h-[200px] bg-[#121212] border-b border-r border-[#484848] relative overflow-hidden">
            <div class="bg-inner absolute w-full h-full bg-cover bg-center group-hover:scale-105 transition-all duration-300" style="background-image: url('{{ $box['background_img'] }}')"></div>
            <div class="inner-link h-full w-full p-5 flex flex-col justify-between relative">
              ...
              <div class="text-box">
                <h4 class="text-4xl font-semibold bg-[length:425px_199px] bg-[-20px_110px] mb-2" style="color: {{ isset($box['title_color']) || $box['title_color'] !== '' ? $box['title_color'] : 'white' }};">{{ $box['button_title'] }}</h4>
                <p class="text-white font-baijam font-light hidden">{{ $box['description'] }}</p>
              </div>
            </div>
          </a> --}}
        @elseif ($loop->index <= 2)
        <a href="{{ $box['link'] }}" class="box group text-white h-[200px] bg-[#121212] border-b border-r border-[#484848] relative overflow-hidden">
          <div class="bg-inner absolute w-full h-full bg-cover bg-center lg:group-hover:scale-125 transition-all duration-[500ms] ease-[cubic-bezier(0.83,0,0.03,0.99)]" style="background-image: url('{{ $box['background_img'] }}')"></div>

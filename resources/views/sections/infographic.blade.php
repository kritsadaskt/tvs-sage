...
<div id="infographic" class="min-h-fit bg-white pt-14 pb-[70px]">
  <div class="container flex-col-reverse md:flex-row flex gap-5">
    <div id="infos_slides_wrapper" class="w-full md:w-7/12 flex flex-col gap-4 px-4 md:px-0 pb-8 justify-end">
      ...
      <div id="show_title_box" class="flex">
        <h4 class="info-text-shows text-[46px] font-bold text-black leading-tight animate__animated animate__fadeIn">{{ $info_1['info_title'] }}</h4>

        <div id="infos_slides_nav" class="flex relative w-60 md:w-28 h-12 mb-4">
